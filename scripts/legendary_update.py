...
topics = [
    "mathematics","bit-magic","recursion","arrays","searching",
    "sorting","matrix","hashing","strings","linked-list",
    "stack","queue","deque","tree","binary-search-tree",
    "heap","graph","greedy","backtracking",
    "dynamic-programming","trie","segment-tree","disjoint-set"
]
...
for root, dirs, files in os.walk("problems"):
    for d in dirs:
        name=d.lower()
        if "easy" in name: easy+=1
        elif "medium" in name: medium+=1
        elif "hard" in name: hard+=1
